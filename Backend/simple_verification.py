#!/usr/bin/env python3
"""
Simple verification of extraction module
"""
import sys
import os
import tempfile
...
def verify_endpoint_isolation():
    ...
    print("Verifying endpoint isolation...")
    
    extraction_file = Path("backend_app/api/v1/extraction.py")
    ...
    print("  Endpoint is properly isolated (no brain/orchestrator/ATS imports)")
    return True
